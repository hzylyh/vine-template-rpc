...
type EmonitorClient interface {
	...
	ListSite(ctx context.Context, in *ListSiteRequest, opts ...grpc.CallOption) (*ListSiteReply, error)
}
...
func (c *emonitorClient) ListSite(ctx context.Context, in *ListSiteRequest, opts ...grpc.CallOption) (*ListSiteReply, error) {
	out := new(ListSiteReply)
...
func (UnimplementedEmonitorServer) ListSite(context.Context, *ListSiteRequest) (*ListSiteReply, error) {
