...
type SystemClient interface {
	...
	// ---- list 获取用户列表 ----
	ListUser(ctx context.Context, in *ListUserRequest, opts ...grpc.CallOption) (*page.Page, error)
	// -------- role 角色相关 --------
	// ---- add 新增角色信息 ----
...
func (c *systemClient) ListUser(ctx context.Context, in *ListUserRequest, opts ...grpc.CallOption) (*page.Page, error) {
	out := new(page.Page)
...
func (UnimplementedSystemServer) ListUser(context.Context, *ListUserRequest) (*page.Page, error) {
