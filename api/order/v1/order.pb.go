...
type ReviewOrderRequest struct {
	...
	OperatorPhone    string `protobuf:"bytes,6,opt,name=operatorPhone,proto3" json:"operatorPhone,omitempty"`
	OperatorEmail    string `protobuf:"bytes,7,opt,name=operatorEmail,proto3" json:"operatorEmail,omitempty"`
	OperatorRemark   string `protobuf:"bytes,8,opt,name=operatorRemark,proto3" json:"operatorRemark,omitempty"`
	OperatorTime     string `protobuf:"bytes,9,opt,name=operatorTime,proto3" json:"operatorTime,omitempty"`
	OperatorIp       string `protobuf:"bytes,10,opt,name=operatorIp,proto3" json:"operatorIp,omitempty"`
	OperatorLocation string `protobuf:"bytes,11,opt,name=operatorLocation,proto3" json:"operatorLocation,omitempty"`
}

func (x *ReviewOrderRequest) Reset() {
	*x = ReviewOrderRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReviewOrderRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReviewOrderRequest) ProtoMessage() {}

func (x *ReviewOrderRequest) ProtoReflect() protoreflect.Message {
	mi := &file_order_v1_order_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReviewOrderRequest.ProtoReflect.Descriptor instead.
func (*ReviewOrderRequest) Descriptor() ([]byte, []int) {
	return file_order_v1_order_proto_rawDescGZIP(), []int{10}
}

func (x *ReviewOrderRequest) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *ReviewOrderRequest) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *ReviewOrderRequest) GetRemark() string {
	if x != nil {
		return x.Remark
	}
	return ""
...
func (x *ReviewOrderRequest) GetOperator() string {
	if x != nil {
		return x.Operator
	}
	return ""
...
func (x *ReviewOrderRequest) GetOperatorName() string {
	if x != nil {
...
func (x *ReviewOrderRequest) GetOperatorPhone() string {
	if x != nil {
...
func (x *ReviewOrderRequest) GetOperatorEmail() string {
	if x != nil {
...
func (x *ReviewOrderRequest) GetOperatorRemark() string {
	if x != nil {
		return x.OperatorRemark
	}
	return ""
}

func (x *ReviewOrderRequest) GetOperatorTime() string {
	if x != nil {
...
func (x *ReviewOrderRequest) GetOperatorIp() string {
	if x != nil {
		return x.OperatorIp
	}
	return ""
...
func (x *ReviewOrderRequest) GetOperatorLocation() string {
	if x != nil {
...
type ReviewOrderReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ReviewOrderReply) Reset() {
	*x = ReviewOrderReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReviewOrderReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReviewOrderReply) ProtoMessage() {}

func (x *ReviewOrderReply) ProtoReflect() protoreflect.Message {
	mi := &file_order_v1_order_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReviewOrderReply.ProtoReflect.Descriptor instead.
func (*ReviewOrderReply) Descriptor() ([]byte, []int) {
...
var file_order_v1_order_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0xf8, 0x02, 0x0a, 0x12, 0x52, 0x65, 0x76, 0x69,
	0x65, 0x77, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e,
	...
	,
	...
	0x12, 0x4f, 0x0a, 0x0b, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12,
	0x20, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x44,
	...
	0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c,
	0x79, 0x12, 0x46, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x1d, 0x2e,
	...
	0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x3b, 0x0a, 0x09, 0x4c, 0x69, 0x73,
	0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x1e, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x6f, 0x72, 0x64,
	...
	,
...
var file_order_v1_order_proto_goTypes = []interface{}{
	...
	(*ReviewOrderRequest)(nil), // 10: api.order.v1.ReviewOrderRequest
	(*ReviewOrderReply)(nil),   // 11: api.order.v1.ReviewOrderReply
	(*page.Page)(nil),          // 12: vine.api.Page
}
var file_order_v1_order_proto_depIdxs = []int32{
	...
	10, // 5: api.order.v1.Order.ReviewOrder:input_type -> api.order.v1.ReviewOrderRequest
	1,  // 6: api.order.v1.Order.AddOrder:output_type -> api.order.v1.AddOrderReply
	3,  // 7: api.order.v1.Order.UpdateOrder:output_type -> api.order.v1.UpdateOrderReply
	5,  // 8: api.order.v1.Order.DeleteOrder:output_type -> api.order.v1.DeleteOrderReply
	7,  // 9: api.order.v1.Order.GetOrder:output_type -> api.order.v1.GetOrderReply
	12, // 10: api.order.v1.Order.ListOrder:output_type -> vine.api.Page
	11, // 11: api.order.v1.Order.ReviewOrder:output_type -> api.order.v1.ReviewOrderReply
...
func file_order_v1_order_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_order_v1_order_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReviewOrderRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
