...
func (sq *SiteQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (sq *SiteQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (sq *SiteQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (sq *SiteQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (sq *SiteQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (sq *SiteQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
